...
- **Documentation Updates**
  ...
  - Added filtering configuration examples
  - Enhanced security documentation with ReDoS prevention details
...
**Note:** This version was tagged but not published to PyPI. See v1.0.5 for the published release.
